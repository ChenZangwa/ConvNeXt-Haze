# -*- coding=utf-8 -*-
import glob #处理文件夹、路径
import platform
import time #计时
from PIL import Image #图像处理包
from pip._vendor.distlib.compat import raw_input
from skimage.feature import hog #hog特征
...
# 训练集图片的位置
train_image_path = 'train-image128'
# 测试集图片的位置
test_image_path = 'test-image128'

# 训练集标签的位置
train_label_path = os.path.join('train-image128','train.txt')
# 测试集标签的位置
test_label_path = os.path.join('test-image128','test.txt')
